...
import { Shield, ArrowLeft, Bell, Calendar, AlertTriangle } from "lucide-react";
...
export default function RemindersPage() {
  ...
  // Get receipts with warranties, sorted by expiry
  ...
  const expiringSoon = warrantyReceipts.filter(
        ...
        {warrantyReceipts.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600">
              Upload receipts with warranty dates to get reminders
            </p>
          </div>
        ) : (
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="text-right">
          ...
          >
            {status === "expired"
              ? "Expired"
              : `${receipt.daysUntilExpiry} days left`}
          </div>
          <p className="text-sm text-gray-500">
